...
namespace BankLibrary
{
    ...
    public class Bank <T> where T : Account 
    {
        ...
        public void Open(AccountType accountType, decimal sum,
            AccountStateHandler addSumHandler, AccountStateHandler widthdrawSumHandler,
            ...
            AccountStateHandler openAccountHandler)
        {
            ...
            // установка обработчика событий счета
            newAccount.Added += addSumHandler;
            newAccount.Withdrawed += widthdrawSumHandler;
